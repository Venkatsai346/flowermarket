...
export const PRODUCT_TYPE_META = {
  ...
  apparel: { label: 'Apparel', tone: 'violet' },
  footwear: { label: 'Footwear', tone: 'amber' },
  beauty: { label: 'Beauty', tone: 'rose' },
  grocery: { label: 'Grocery', tone: 'emerald' },
  electronics: { label: 'Electronics', tone: 'sky' },
  home: { label: 'Home & living', tone: 'amber' },
  furniture: { label: 'Furniture', tone: 'slate' },
  book: { label: 'Books', tone: 'sky' },
  toy: { label: 'Toys', tone: 'violet' },
  jewellery: { label: 'Jewellery', tone: 'amber' },
  automotive: { label: 'Automotive', tone: 'slate' },
  pet_supply: { label: 'Pet supplies', tone: 'emerald' },
  sports: { label: 'Sports', tone: 'sky' },
  digital_good: { label: 'Digital goods', tone: 'violet' },
  service: { label: 'Services', tone: 'sky' },
  bundle: { label: 'Bundles', tone: 'rose' },
