...
export function createEndpoints(client) {
  ...
  return {
    ...
    catalogAdmin: {
      ...
      updateVariant: (id, variantId, body) => c.patch(`/catalog/admin/masters/${id}/variants/${variantId}`, body),
      removeVariant: (id, variantId, body) => c.del(`/catalog/admin/masters/${id}/variants/${variantId}`, { body }),
      addVariantImage: (id, variantId, body) => c.post(`/catalog/admin/masters/${id}/variants/${variantId}/images`, body),
    ...
    shop: {
      ...
      product: (id, q = {}) => c.get(`/catalog/products/${id}`, { query: q }),
      productBySlug: (slug, q = {}) => c.get(`/catalog/p/${slug}`, { query: q }),
      stock: (id, q = {}) => c.get(`/catalog/products/${id}/stock`, { query: q }),
