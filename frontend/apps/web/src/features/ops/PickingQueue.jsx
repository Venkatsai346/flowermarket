...
const FILTERS = [
  ['', 'All queue'],
  ['confirmed', 'Confirmed (to pick)'],
  ['picking', 'Picking'],
  ['packed', 'Packed (ready)'],
];

export default function PickingQueue({ refreshKey = 0, onOpen }) {
  ...
  return (
    <Card
      title="Picking queue"
      subtitle="Confirmed → picking → packed. Every action is audited by the order saga."
