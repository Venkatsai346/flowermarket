...
export const ledgerAccounts = {
  ...
  subscriptionIncome: () => LEDGER_ACCOUNT.PLATFORM_SUBSCRIPTION_INCOME,
...
const TYPE_BY_PREFIX = {
  ...
  [LEDGER_ACCOUNT.PLATFORM_SUBSCRIPTION_INCOME]: LEDGER_ACCOUNT_TYPE.INCOME,
...
const ACCOUNT_NAMES = {
  ...
  [LEDGER_ACCOUNT.PLATFORM_SUBSCRIPTION_INCOME]: 'Platform subscription income',
